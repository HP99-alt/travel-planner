...
export const translations = {
  en: {
    ...
    'itinerary.removeDay': 'Remove Day',
    'itinerary.removeDayConfirm': 'Remove this day? Its activities will be deleted too.',
    'itinerary.editDates': 'Trip Dates',
    'itinerary.startDate': 'Start Date',
    'itinerary.daysLabel': 'days',
  ...
  zh: {
    ...
    'itinerary.addDay': '增加一天',
    'itinerary.removeDay': '删除当天',
    'itinerary.removeDayConfirm': '确定删除这一天吗？该天的行程也会一并删除。',
    'itinerary.editDates': '旅行日期',
    'itinerary.startDate': '开始日期',
    'itinerary.daysLabel': '天',
